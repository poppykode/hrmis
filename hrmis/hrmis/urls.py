"""
URL configuration for hrmis project.
...
urlpatterns = [
    ...
    path('accounts/', include('app_settings.urls')),
    ...
    path('reset', auth_views.PasswordResetView.as_view(template_name='accounts/password_reset.html'), name='password_reset'),
